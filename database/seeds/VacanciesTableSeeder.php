...
class VacanciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Vacancies::create([
            ...
            'COUNTRY' => 'Belarus',
            'CITY' => 'Minsk',
            'job_category_id' => DB::table('job_categories')->where('NAME', 'PHP')->first()->id,
        ...
        Vacancies::create([
            ...
            'COUNTRY' => 'Belarus',
            'CITY' => 'Minsk',
            'job_category_id' => DB::table('job_categories')->where('NAME', 'java')->first()->id,
        ...
        Vacancies::create([
            ...
            'COUNTRY' => 'Belarus',
            'CITY' => 'Minsk',
            'job_category_id' => DB::table('job_categories')->where('NAME', 'swift')->first()->id,
            'COMPANY_ID' => DB::table('users')->where('NAME', 'EPAM')->first()->id,
            'SALARY_FROM' => 2500,
            'ACTIVE' => 1,
        ...
        Vacancies::create([
            ...
            'COUNTRY' => 'Ukraine',
            'CITY' => 'Kharkov',
            'job_category_id' => DB::table('job_categories')->where('NAME', 'go')->first()->id,
            'COMPANY_ID' => DB::table('users')->where('NAME', 'EPAM')->first()->id,
            'SALARY_FROM' => 400,
            'ACTIVE' => 1,
        ...
        Vacancies::create([
            ...
            'COUNTRY' => 'USA',
            'CITY' => 'Boston',
            'job_category_id' => DB::table('job_categories')->where('NAME', 'ruby')->first()->id,
        ...
        Vacancies::create([
            ...
            'COUNTRY' => 'Russia',
            'CITY' => 'Moscow',
            'job_category_id' => DB::table('job_categories')->where('NAME', 'javascript')->first()->id,
            'COMPANY_ID' => DB::table('users')->where('NAME', 'iTechArt')->first()->id,
            'SALARY_FROM' => 1200,
            'ACTIVE' => 1,
        ...
        Vacancies::create([
            ...
            'COUNTRY' => 'Belarus',
            'CITY' => 'Minsk',
            'job_category_id' => DB::table('job_categories')->where('NAME', 'python')->first()->id,
